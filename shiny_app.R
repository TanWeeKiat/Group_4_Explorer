...
Home.fluidPage = fluidPage(
  ...
  fluidRow(column(offset = OFFSET, width = CONTENT_WIDTH,
      tags$div(
        ...
        tags$p(strong("Data Science Process Tab:"), "Show the data science process to produce this shiny application.", style = "font-size: 22px"),
...
ui <- navbarPage("World Covid-19 VaccBoard",
